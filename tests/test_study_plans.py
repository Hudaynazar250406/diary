...
def test_create_study_plan_nonexistent_group(
    client,
    seed,
):
...
def test_create_study_plan_nonexistent_discipline(
    client,
    seed,
):
...
def test_create_study_plan_missing_fields(
    client,
):
