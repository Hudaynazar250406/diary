...
def test_create_grade_nonexistent_student(
    client,
    seed,
):
    response = client.post(
...
def test_create_grade_nonexistent_discipline(
    client,
    seed,
):
    response = client.post(
...
def test_create_grade_outside_study_plan(
    client,
    seed,
):
    response = client.post(
